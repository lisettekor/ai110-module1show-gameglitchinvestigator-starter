...
# Clear the input by removing the session state key
...
if st.session_state.show_hint and st.session_state.hint_message:
    ...
    if not ok:
        ...
        if outcome == "Win":
            ...
            if st.session_state.attempts >= attempt_limit:
                ...
                # Only rerun if game is still being played
